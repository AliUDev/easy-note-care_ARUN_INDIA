      ...
      {/* <div className="card card-flush h-md-100">
        <div className="card-header">
          <div className="card-title">
            ...
            <h2>Individual Medical Information</h2>
          </div>
        </div>
        <div className="card-body pt-1">
          <div className="d-flex flex-column text-gray-600">
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/individual-medical-information/diagnosis-list">Diagnosis List</Link>
            </div>
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/individual-medical-information/advance-directives">Advance Directives</Link>
            </div>
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/individual-medical-information/allergy-profile">Allergy Profile</Link>
            </div>
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/individual-medical-information/medication-profile">Medication Profile</Link>
            </div>
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/individual-medical-information/medication-reconciliation">Medication Reconciliation</Link>
            </div>
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/individual-medical-information/individual-history">Individual History</Link>
            </div>
          </div>
        </div>
      </div> */}
          ...
          >
            ...
            <div className='d-flex align-items-center mb-6'>
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                ...
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'><Link style={{ color: "inherit" }} to="/care/individual-medical-information/diagnosis-list">Diagnosis List</Link>
                  </div>
                </div>
                {/* end::Title */}
              </div>
            ...
            <div className='d-flex align-items-center mb-6'>
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                {/* begin::Title */}
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'><Link style={{ color: "inherit" }} to="/care/individual-medical-information/allergy-profile">Allergy Profile</Link>
                  </div>
                </div>
                {/* end::Title */}
            ...
            <div className='d-flex align-items-center mb-6'>
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                {/* begin::Title */}
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'><Link style={{ color: "inherit" }} to="/care/individual-medical-information/medication-profile">Medication Profile</Link>
                  </div>
                </div>
                {/* end::Title */}
