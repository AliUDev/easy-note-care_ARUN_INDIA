      ...
      {/* <div className="card card-flush h-md-100">
        <div className="card-header">
          <div className="card-title">
            ...
            <h2>IPOP Individualized Services</h2>
          </div>
        </div>
        <div className="card-body pt-1">
          <div className="d-flex flex-column text-gray-600">
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/ipop-individualized-services/new">New</Link>
            </div>
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/ipop-individualized-services/acknowledge">Acknowledge</Link>
            </div>
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/ipop-individualized-services/archive">Archive</Link>
            </div>
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/ipop-individualized-services/search">Search</Link>
            </div>
          </div>
        </div>
      </div> */}
        ...
        <div className='card-body p-0'>
          ...
          <div className={`px-9 pt-7 card-rounded  w-100`}>
            ...
            <div className='d-flex flex-stack'>
              <h3 className='m-0 fw-bolder fs-3'>IPOP Individualized Services</h3>
          ...
          >
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                ...
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'>
                    <Link style={{ color: "inherit" }} to="/care/ipop-individualized-services/new">New</Link>
                  </div>
                </div>
                {/* end::Title */}
              </div>
            ...
            <div className='d-flex align-items-center mb-6'>
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                ...
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'>
                    <Link style={{ color: "inherit" }} to="/care/ipop-individualized-services/acknowledge">Acknowledge</Link>
                  </div>
                </div>
                {/* end::Title */}
            ...
            <div className='d-flex align-items-center mb-6'>
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                ...
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'>
                    <Link style={{ color: "inherit" }} to="/care/ipop-individualized-services/archive">Archive</Link>
                  </div>
                </div>
                {/* end::Title */}
            ...
            <div className='d-flex align-items-center'>
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                ...
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'>
                    <Link style={{ color: "inherit" }} to="/care/ipop-individualized-services/search">Search</Link>
                  </div>
                </div>
                {/* end::Title */}
