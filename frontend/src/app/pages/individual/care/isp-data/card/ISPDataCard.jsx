        ...
        <div className="card-body pt-1">
          <div className="d-flex flex-column text-gray-600">
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/isp-data/new" >New</Link>
            </div>
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/isp-data/search">Search</Link>
            </div>
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/isp-data/report">Report </Link>
            </div>
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/isp-data/search-report">Search Report</Link>
            </div>
            <div className="d-flex align-items-center text-hover-primary py-2">
              <span className="bullet bg-primary me-3" /><Link style={{ color: "inherit" }} to="/care/isp-data/archive">Archive</Link>
            </div>
          </div>
        </div>
      </div> */}
          ...
          >
            ...
            <div className='d-flex align-items-center mb-6'>
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                ...
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'><Link style={{ color: "inherit" }} to="/care/isp-data/new" >New</Link>
                  </div>
                </div>
                {/* end::Title */}
              </div>
            ...
            <div className='d-flex align-items-center mb-6'>
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                {/* begin::Title */}
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'><Link style={{ color: "inherit" }} to="/care/isp-data/report">Report </Link>
                  </div>
                </div>
                {/* end::Title */}
            ...
            <div className='d-flex align-items-center mb-6'>
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                {/* begin::Title */}
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'><Link style={{ color: "inherit" }} to="/care/isp-data/search-report">Search Report</Link>
                  </div>
                </div>
                {/* end::Title */}
              ...
              <div className='d-flex align-items-center flex-wrap w-100'>
                ...
                <div className='mb-1 pe-3 flex-grow-1'>
                  <div className='fs-5 text-gray-800 text-hover-primary fw-bolder'>
                    <Link style={{ color: "inherit" }} to="/care/isp-data/archive">Archive</Link>
                  </div>
                </div>
                {/* end::Title */}
